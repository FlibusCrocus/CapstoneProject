...
# return the outcomes piechart for a selected site
        ...
        filtered_df2['count'] = 1
        fig2 = px.pie(filtered_df2, values='count', 
        names='class',  
...
def get_scatter(entered_site, payload_range):
    ...
    df_fil = spacex_df[
                (spacex_df['Payload Mass (kg)'] >= min_pay) & 
                (spacex_df['Payload Mass (kg)'] <= max_pay)
                 ]
    if entered_site =='ALL':
        scatter_df = df_fil
        ...
        scatter_df = df_fil[df_fil['Launch Site'] == entered_site]
